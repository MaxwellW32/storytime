...
export default function Home({ allstories, updateStory, newStory, deleteStory }: { allstories: StoryData[], updateStory: (option: string, seeBoard: StoryData) => Promise<void>, newStory: (newStory: StoryDataSend) => Promise<void>, deleteStory: (seenId: string) => Promise<void> }) {
